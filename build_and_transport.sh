...
cmake --build . --target host_allgather
...
ssh pku1 "rm -f /root/host_simple_test /root/host_reduce /root/host_broadcast /root/host_barrier /root/host_reducescatter /root/host_allgather"
...
rsync -av repository/build/host_allgather pku1:/root/

echo "[6/7] Deploying to pku2..."
ssh pku2 "rm -f /root/host_simple_test /root/host_reduce /root/host_broadcast /root/host_barrier /root/host_reducescatter /root/host_allgather"
...
rsync -av repository/build/host_allgather pku2:/root/

echo "[7/7] Deploying to pku3 and pku4..."
ssh pku3 "rm -f /root/host_simple_test /root/host_reduce /root/host_broadcast /root/host_barrier /root/host_reducescatter /root/host_allgather"
...
rsync -av repository/build/host_allgather pku3:/root/
ssh pku4 "rm -f /root/host_simple_test /root/host_reduce /root/host_broadcast /root/host_barrier /root/host_reducescatter /root/host_allgather"
...
rsync -av repository/build/host_allgather pku4:/root/
